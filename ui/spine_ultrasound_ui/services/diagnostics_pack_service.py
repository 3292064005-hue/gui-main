...
class DiagnosticsPackService:
    ...
    def build(self, session_dir: Path) -> dict[str, Any]:
        ...
        return {
            ...
            "sensor_snapshot": {
                "pressure_timeline": pressure_timeline.get("summary", {}),
                "ultrasound_metrics": ultrasound_metrics.get("summary", {}),
                "pressure_analysis": pressure_analysis.get("summary", {}),
                "ultrasound_analysis": ultrasound_analysis.get("summary", {}),
            },
