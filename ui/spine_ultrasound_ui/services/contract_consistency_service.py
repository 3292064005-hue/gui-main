...
class ContractConsistencyService:
    REQUIRED_ARTIFACTS = {
        ...
        "localization_readiness": "meta/localization_readiness.json",
        "calibration_bundle": "meta/calibration_bundle.json",
        "localization_freeze": "meta/localization_freeze.json",
        "manual_adjustment": "meta/manual_adjustment.json",
        "source_frame_set": "derived/sync/source_frame_set.json",
        "localization_replay_index": "replay/localization_replay_index.json",
