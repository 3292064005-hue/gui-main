...
COMMAND_SPECS: dict[str, dict[str, Any]] = {
    ...
    "run_rl_project": {"required_payload_fields": [], "state_preconditions": ["AUTO_READY", "SESSION_LOCKED", "PATH_VALIDATED", "SCAN_COMPLETE"]},
    "pause_rl_project": {"required_payload_fields": [], "state_preconditions": ["AUTO_READY", "SCANNING", "PAUSED_HOLD", "SESSION_LOCKED", "PATH_VALIDATED", "SCAN_COMPLETE"]},
    "enable_drag": {"required_payload_fields": [], "state_preconditions": ["CONNECTED"]},
    "disable_drag": {"required_payload_fields": [], "state_preconditions": ["CONNECTED"]},
    "replay_path": {"required_payload_fields": [], "state_preconditions": ["AUTO_READY", "PATH_VALIDATED", "SCAN_COMPLETE"]},
    "start_record_path": {"required_payload_fields": [], "state_preconditions": ["CONNECTED"]},
    "stop_record_path": {"required_payload_fields": [], "state_preconditions": ["CONNECTED"]},
    "cancel_record_path": {"required_payload_fields": [], "state_preconditions": ["CONNECTED"]},
    "save_record_path": {"required_payload_fields": [], "state_preconditions": ["CONNECTED"]},
