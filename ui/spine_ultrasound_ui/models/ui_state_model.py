...
class WorkflowArtifacts:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "localization_review_required": self.localization_review_required,
            "localization_review_approved": self.localization_review_approved,
            "localization_source_type": self.localization_source_type,
