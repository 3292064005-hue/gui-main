...
const std::vector<CommandRegistryEntry>& commandRegistry() {
  static const std::vector<CommandRegistryEntry> kRegistry = {
      ...
      {"run_rl_project", true, "AUTO_READY|SESSION_LOCKED|PATH_VALIDATED|SCAN_COMPLETE"},
      {"pause_rl_project", true, "AUTO_READY|SCANNING|PAUSED_HOLD|SESSION_LOCKED|PATH_VALIDATED|SCAN_COMPLETE"},
      {"enable_drag", true, "CONNECTED"},
      {"disable_drag", true, "CONNECTED"},
      {"replay_path", true, "AUTO_READY|PATH_VALIDATED|SCAN_COMPLETE"},
      {"start_record_path", true, "CONNECTED"},
      {"stop_record_path", true, "CONNECTED"},
      {"cancel_record_path", true, "CONNECTED"},
      {"save_record_path", true, "CONNECTED"},
