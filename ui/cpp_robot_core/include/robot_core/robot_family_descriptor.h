...
struct RobotFamilyDescriptor {
  ...
  std::string family_label{"xMate3 Clinical Mainline"};
  ...
  std::map<std::string, std::string> safe_defaults{{"preferred_link", "wired_direct"}, {"clinical_rt_mode", "cartesianImpedance"}, {"sdk_robot_class", "xMateRobot"}};
};
