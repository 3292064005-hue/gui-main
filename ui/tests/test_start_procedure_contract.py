...
def test_start_procedure_is_canonical_and_start_scan_is_alias() -> None:
    ...
    assert commands['start_scan']['canonical_command'] == 'start_procedure'
    assert commands['start_scan']['alias_kind'] == 'compatibility_alias'
